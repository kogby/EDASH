...
def generate_stack_prediction(X_train, y_train, X_test, y_test):
    ...
    return {
        ...
        'Precision': precision_score(y_test, predict_results, average = 'weighted'),
        'Recall': recall_score(y_test, predict_results, average = 'weighted'),
        'F1': f1_score(y_test, predict_results, average = 'weighted'),
    }
